...
![Στιγμιότυπο οθόνης (714)](https://user-images.githubusercontent.com/100956280/201228472-6a1950d6-f414-4fb6-a3a8-d085fd4e21dc.png)
...
- Πρόσθεσα αυτό το κομμάτι κώδικα για να κινείται ο χαρακτήρας δεξία, αριστερά, πάνω και κάτω.
    ...
    - Επίσης έφτιαξα shorting layers για το background, το παίχτη και τα διακοσμητικά έτσι ώστε να υπάρχει ταξινομηση και αναλογα σε ποιο layer βρίσκονται τα sprites. 
